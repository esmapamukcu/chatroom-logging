...
def accept_incoming_connections():
    ...
    while True:
        ...
        client.send("Greetings from the ChatRoom! ".encode("utf8"))              ##encode yaparak kodluyoruz ki kolayca ulaşamazsın başkaları
...
def handle_client(conn, addr):  # Takes client socket as argument.
    ...
    name = conn.recv(BUFSIZ).decode("utf8")                                       ##gelen mesajdan 1024lük alır iletir(recv).
    ...
    while True:
        ...
        #if msg == "%teror%" :
            #conn.send('Bu konuda paylaşımda bulunamazsınız!')
